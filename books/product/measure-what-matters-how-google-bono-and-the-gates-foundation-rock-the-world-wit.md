...
“John	Doerr	is	a	Silicon	V alley	legend.	He	explains	how	transparently	setting
...
“In	addition	to	being	a	terrific	personal	history	of	tech	in	Silicon	V alley,
...
scanning,	or	distributing	any	part	of	it	in	any	form	without	permission.	Y ou	are	supporting	writers	and	allowing	Penguin	to
...
Description:	New	Y ork	:	Portfolio/Penguin,	[2018]	|	Includes	bibliographical	references.
...
A	robotics	pioneer	leverages	OKRs	for	teamwork	and	leadership—and	to	create	the
perfect	pizza.
18	Culture
...
can’t	users	load	a	video	on	Y ouTube	almost	instantly?	Isn’t	that	more
...
there.
—Y ogi	Berra
n	a	fall	day	in	1999,	in	the	heart	of	Silicon	V alley,	I	arrived	at	a	two-
...
Just	to	be	sure,	I	said,	“Y ou	mean	market	cap,	right?”
...
my	executive	team	and	rallied	the	whole	operation.	Y es,	we	made	our	share	of
...
say,	“It’s	not	a	key	result	unless	it	has	a	number.”)	Y ou	either	meet	a	key
...
goals.
Y ear	after	year,	Gallup	surveys	attest	to	a	“worldwide	employee
...
data-driven	apparatus	for	a	freewheeling,	data-worshipping	enterprise.*
	They
...
household	names	far	beyond	Silicon	V alley:	Anheuser-Busch,	BMW,	Disney,
...
Y et	Google’s	leaders	have	never	faltered.	Their	hunger	for	learning	and
...
more	users	apiece:	Search,	Chrome,	Android,	Maps,	Y ouTube,	Google	Play,
and	Gmail.	In	2008,	a	company-wide	OKR	rallied	all	hands	around	the	Code
Y ellow	battle	against	latency—Google’s	bête	noire,	the	lag	in	retrieving	data
...
and	here	are	the	OKRs	we	have	written	for	the	year.’”*
	(In	accordance	with
...
Africa	to	Y ouTube	and	its	quest	for	10x	growth.	Collectively	these	stories
...
dumped	me	and	was	working	in	Silicon	V alley,	but	I	didn’t	know
where.	It	was	the	summer	of	1975,	between	terms	at	Harvard	Business
School.	I	drove	through	Y osemite	and	arrived	in	the	V alley	with	no	job	and	no
...
I’d	hoped	to	land	an	internship	at	one	of	the	V alley’s	venture	capital	firms,
...
V alley	and	led	it	to	phenomenal	success.	During	Grove’s	eleven-year	tenure
...
and	without	any	arguments:	Did	I	do	that	or	did	I	not	do	it?	Y es?	No?
...
efficient	and	profitable	organization	was	authoritarian.*
	Scientific
...
T op-down Bottom-up	or	Sideways	(~50%)
...
Y ou	can	have	all	the	technical	expertise	in	the	world,	but	you’ll	succeed	or
...
pantheon	of	management	philosophy.	Y et	Grove	changed	the	way	we	live.	In
...
magazine’s	Man	of	the	Y ear,	“the	person	most	responsible	for	the	amazing
...
Set	goals	from	the	bottom	up.	T o	promote	engagement,	teams	and	individuals
...
chapter	7,	“Superpower	#2:	Align	and	Connect	for	T eamwork.”)
...
review.”	T o	encourage	risk	taking	and	prevent	sandbagging,	OKRs	and	bonuses
...
OKRs	for	Operation	Crush,	which	are	sampled	here
,	were	classics	of	the
...
awfully	fast.	Intel	was	close	to	a	billion-dollar	company	at	the	time,	and	it	turned	on	a	dime.	T o
...
marketing	departments,	and	three	geographic	locations—all	pulling	together	as	one.*
	What
...
the	new-and-improved	Y ouTube	search	engine—these	products	and	dozens
...
energizing	OKRs	often	originate	with	frontline	contributors.	As	a	Y ouTube
...
to	channel	subscriptions.	Much	of	Y ouTube’s	value	was	effectively	hidden	to
...
Y ouTube	CEO	Salar	Kamangar,	who	consulted	with	Google	CEO	Larry	Page.
...
Crush,	everyone	rallied	to	help	Rick’s	group	succeed.	The	Y ouTube	cadre
...
line	goals	must	be	clearly	understood	throughout	the	organization.	Y et	by
...
T en	sales	calls Two	new	orders Lead	quality	will	improve	to	meet
...
V oltaire:	Don’t	allow	the	perfect	to	be	the	enemy	of	the	good.*	Remember
...
speed	by	2	percent.
Key	result:	T est	at	wind	tunnel	ten
times.
...
They	were	a	force	in	lockstep,	T eam	Brett,	and	they	would	not	let	me	fail.	I’m	sure	I	didn’t	fully
...
with	liability.	T eachers	needed	a	secure	platform	with	no	personal	data	attached,	something
...
By	Day	70,	our	software	was	in	place.	T eachers	could	sign	up	on	the	web,	form	a	virtual
...
founded	MightyT ext	and	became	my	mentor.	Remind	kept	scaling	like	crazy	on	our	seed-
...
concrete.	We	listed	three	metrics:	Weekly	Active	T eachers	(WAT),	Monthly	Active	T eachers
(MAT),	and	retention.
...
next	level.	T o	meet	our	objective	for	teacher	engagement,	with	its	time-bound	key	result,	we
...
For	example:	T o	this	day,	one	of	our	most	requested	features	is	a	repeated	message.	Say
...
and	to	finish	within	a	year.	T o	deliver,	we’d	need	more	focus	and	commitment	than	ever	before.
...
your	OKRs!”
T o	inspire	true	commitment,	leaders	must	practice	what	they	teach.	They	must	model	the
...
T oday,	with	the	invaluable	support	of	our	CMS	partners,	Nuna	has	built	a	secure,	flexible
...
for	our	daily	lives.	It’s	the	express	lane	to	operating	excellence.	Y et
...
trouble	spots	wherever	they	surface.	Adds	Bock:	“Y ou	can	see	immediately	if
...
for	everyone.	Y ou	kick	off	virtuous	cycles	that	reinforce	your	ability	to
...
obvious	inefficiency,	our	customers’	experience	would	be	inconsistent.	T o	their	credit,	the	two
...
moment	of	clarity.	T o	the	extent	we’ve	succeeded	as	a	company,	it’s	in	helping	to	provide
...
could	read	people	and	he	invested	in	them.	Y ou	always	knew	what	he	was
...
brands	(TurboT ax,	Quicken,	QuickBooks)	to	the	branded	house	of	Intuit.
...
time	to	follow	up.
At	Intuit,	change	started	at	the	top.	T o	jump-start	our	transformation,	our	chairman	and
...
creating	new	functionality,	finding	future-oriented	solutions.	T o	become	the	team	Intuit	needed,
...
T oday,	every	employee	in	my	department	owns	three	to	five	business	objectives	per
...
used	to	run	Intuit.”	(See	here
.)	Lately,	whenever	I	travel	to	see	a	team	in	T exas	or	Arizona,	I
...
slipped.
T o	attack	the	problem	in	a	more	connected	way,	we	upgraded	a	key	result	for	workforce
...
No	exceptions,	no	opt-outs.	Y es,	there	will	be	late	adopters,	resisters,	and
...
chances	of	reaching	it.	Y our	odds	are	better	still	if	you	monitor	progress	while
...
Intel	followed	a	similar	formula.	Y ou	may	recall	the	OKR	for	Operation
...
key	result	is	fifty	phone	calls.	Y ou	wind	up	calling	thirty-five	prospects,	for	a
...
pieces	published,	one	is	a	cover	story	in	The	Wall	Street	Journal.	Y our	raw
...
Table	10.1:	Scoring	and	Assessment	V ariations
...
the	team	to	celebrate	your	growing	OKR	superpowers.	Y ou’ve	earned	it.
...
the	mosquito.*
	In	2016,	the	Gates	Foundation	teamed	with	the	British
...
is	like	oxygen:	Y ou	cannot	win	without	it.
...
V enter—to	choose	fourteen	“Grand	Engineering	Challenges”	for	the	twenty-
...
the	brain.	Prevent	nuclear	terror.	Secure	cyberspace.	(Y ou	get	the	picture.)
...
doing	the	same	thing	as	everybody	else.	Y ou	probably	won’t	fail
...
Y ou	know,	in	our	business	we	have	to	set	ourselves	uncomfortably	tough	objectives,	and	then	we
...
Teller:	“If	you	want	your	car	to	get	fifty	miles	per	gallon,	fine.	Y ou	can
...
AJAX.*
	The	early	web	was	a	content	platform,	but	it	was	fast	becoming	an	applications
...
My	first	assignment	was	to	expand	the	use	and	distribution	of	Google	T oolbar,	which	could
be	added	to	any	browser	to	get	you	to	Google	Search.	It	was	the	right	project	for	the	right	time.
In	just	a	few	years,	we	scaled	up	T oolbar	users	by	more	than	10x.	That	was	when	I	first	saw
...
Stretch	OKRs	are	an	intense	exercise	in	problem	solving.	Having	gone	through	the	T oolbar
...
the	company’s	history.	People	still	remember	“Dear	Sophie,”*
	a	spot	created	around	a	father’s
...
Larry	and	I	eventually	settled	on	an	OKR	of	111	million	users,	a	classic	stretch	goal.	T o
...
T oday,	on	mobile	alone,	there	are	more	than	a	billion	active	users	of	Chrome.	We	couldn’t
...
—from	T oolbar	to	Chrome,	for	example.	You	can	never	stop	stretching.	My	father’s	experience
...
Y ouTube	and	how	it	grew—exponentially—with	the	“stretch”	OKR
superpower.
...
later,	as	analysts	doubted	that	Y ouTube	would	survive,	she	was	a	leading
...
By	2012,	Y ouTube	had	become	a	market	leader	and	one	of	the	biggest
...
streams.)	In	2014,	as	the	new	CEO	of	Y ouTube,	she	inherited	one	of	the	most
aggressive	goals	anytime,	anywhere.	Over	a	span	of	four	years,	the	mission
was	to	reach	a	billion	hours	of	people	watching	Y ouTube	every	day—to	grow
by	a	factor	of	ten.	But	Susan	didn’t	want	to	grow	at	any	cost—she	wanted	to
do	this	responsibly.	Susan	and	a	veteran	Y ouTube	engineering	leader,	Cristos
...
reap	tremendous	dividends.	Y ouTube’s	once	struggling	web	video	business
...
structure	and	discipline	of	OKRs.	And	one	more	thing:	Before	Y ouTube	could
...
“T ell	me	your	speed	now.”	And	then:	“Why	can’t	you	cut	that	in	half?”
...
My	argument	was	that	Google	and	YouTube	were	different	animals.	T o	make	the	dichotomy
...
sources.	T o	this	day,	we	are	working	to	incorporate	a	broader	array	of	new	and	meaningful
...
report.	Y et	only	12	percent	of	HR	leaders	deem	the	process	“highly
...
not,	you	lose	context.	Y ou	need	continuous	performance	management	to
...
worked	for	us	last	quarter,	or	is	it	time	to	consider	a	pivot?	Y ou	need	to	elicit
...
Table	15.1:	Annual	Performance	Management	V ersus	Continuous	Performance
Management
...
rebuild	from	scratch.	Y ou	try	to	keep	all	of	that	in	consideration.”	Google	is
...
Grove’s	tenets	are	more	timely	than	ever.*
	Effective	one-on-ones	dig	beneath
...
Negative	feedback:	“Y ou	started	the	meeting	late	last	week,	and	it	came	off
as	disorganized.”
Positive	feedback:	“Y ou	did	a	great	job	with	the	presentation.	Y ou	really
...
the	raters	on	Y elp,	why	can’t	a	workplace	support	two-way	feedback	between
...
S
16
Ditching	Annual	Performance	Reviews:	The
Adobe	Story
Donna	Morris
...
involved.	V oluntary	attrition	spiked	every	February,	as	waves	of	contributors
...
Check-in	has	helped	us	to	live	Adobe’s	values	every	day.	T o	explain	how	the	new	process
...
A
17
Baking	Better	Every	Day:	The	Zume	Pizza
Story
...
V alley,	the	skeptics	came	out	in	droves.	“Roboticized,	artisanal	pizza”	was
...
the	waterfall	stopped	flowing	so	smoothly.	T oo	many	things	were	happening	at	once,	with	lots
...
the	foundation	for	engagement.	Everybody’s	bought	in	to	the	mission.	T eam	sports	don’t	work
...
18
Culture
Y ou	need	a	culture	that	high-fives	small	and	innovative	ideas.
—Jeff	Bezos
...
An	OKR	culture	is	an	accountable	culture.	Y ou	don’t	push	toward	a	goal
just	because	the	boss	gave	you	an	order.	Y ou	do	it	because	every	OKR	is
...
its	broader	values,	as	well.	Y ears	later,	the	company’s	friendly,	inclusive
culture	remains	a	welcome	contrast	to	the	blustery,	combative	personality	of
many	Silicon	V alley	start-ups.
...
T oday’s	transformed	Lumeris	values	interdependence.	It	prizes	intentional	coordination.
...
cofounded	DA TA	(Debt,	AIDS,	Trade,	Africa),	a	global	advocacy
...
complement	to	DA TA ’s	inside	game.
...
magazine’s	Person	of	the	Y ear.
—
...
T om	Freston,	chairman	of	ONE’s	board,	saw	their	value,	so	they	became	part	and	parcel	of
...
congresswoman	from	T exas,	she	probably	thinks	there	are	people	in	ONE	T-shirts
...
organizations	of	all	stripes	and	sizes	move	mountains.	Y ou’ve	heard
...
T
DEDICATION
his	book	is	dedicated	to	two	extraordinary	people	who	left	us,	too	soon,
...
V alley.	He	was	a	world-class	listener,	a	hall-of-fame	mentor,	and	the	wisest
...
Silicon	V alley,	and	by	his	old	marketing	boss	at	Apple,	Floyd	Kvamme,
...
fails.	After	GO	sold	out	to	A T&T,	we	made	sure	that	those	who	were	let	go
...
power	through	the	shortfall.	When	the	board	met	in	a	hotel	suite	in	Las	V egas,
...
it	came	around	to	me,	I	said,	“Y ou	know,	I	think	we	should	go	with	the
...
he	was	giving	back	to	the	V alley	that	had	done	so	much	for	him.	When	a	few
...
with	his	typical	dash	of	salt:	“Y ou’ve	got	to	make	the	f—ing	trains	run	on
...
Steve	persisted,	the	Coach	said,	“Don’t	make	me	choose.	Y ou	are	not	going	to
...
cared.	Y ou	always	knew	he	had	your	back.	Y ou	always	knew	he	was	there	for
the	team.	Y ou	don’t	find	many	leaders	who	can	convey	love	and	fearless
...
Google’s	approach	to	OKRs.	Y our	approach	may—and	should—differ.)
—
...
TRAP	#5:	Low	V alue	Objectives	(aka	the	“Who	cares?”	OKR).	OKRs	must
promise	clear	business	value—otherwise,	there’s	no	reason	to	expend
resources	doing	them.	Low	V alue	Objectives	(LVOs)	are	those	for	which,
...
T oward	the	end	of	the	quarter,	contributors	score	their	OKRs,	perform	a	self-assessment,	and	reflect	on
...
Tedlow
The	Intel	Trinity:	How	Robert	Noyce,	Gordon	Moore,	and	Andy
Grove	Built	the	World’ s	Most	Important	Company,	by	Michael
Malone
Culture
...
forthcoming	book	by	Eric	Schmidt,	Jonathan	Rosenberg,	and	Alan
Eagle
...
I
ACKNOWLEDGMENTS
n	closing	this	edition	of	Measure	What	Matters,	I	feel	an	overwhelming
sense	of	gratitude.	First,	that	I	was	so	lucky	to	be	heir	to	Andy	Grove’s
system	to	amplify	human	potential.	And	then	to	watch	inspiring
entrepreneurs,	leaders,	and	teams	adapt	it	to	reach	for	their	dreams.	I	am	also
thankful	for	our	great	country	that	rewards	risk	taking,	something	I	never	take
for	granted.
Most	of	all,	I	thank	you,	my	readers,	for	your	attention,	engagement,	and
feedback.	I	hope	you’ll	write	to	me	at	john@whatmatters.com.
The	coming-to-be	of	this	book	confirms	my	mantra	that	it	takes	a	team	to
win.	From	inception	to	finished	product,	I	thank	the	Portfolio/Penguin	team
that	made	it	all	possible:	my	publisher,	Adrian	Zackheim,	who	foresaw	its
potential;	my	superlative	editor,	Stephanie	Frerich,	who	went	so	many	extra
miles	and	somehow	kept	her	good	humor;	and	also	Tara	Gilbride,	Olivia
Peluso,	and	Will	Weisser.	I	am	grateful	as	well	to	my	agent,	Myrsini
Stephanides,	and	my	attorney,	Peter	Moldave.	And	to	the	skilled	and	versatile
Ryan	Panchadsaram,	whose	insights	and	judgment	proved	indispensable.
A	special	thank-you	goes	to	the	individuals	who	took	time	out	of	their
impossibly	busy	schedules	to	read	the	manuscript	and	offer	the	feedback	that
...
Thank	you	Tom	Friedman,	Laurene	Powell	Jobs,	Al	Gore,	Randy	Komisar
and	Sheryl	Sandberg,	friends	with	big	brains	and	kind	hearts,	who	shared
...
crystalline	thinking	challenged	and	clarified	my	purpose.	I	couldn’t	have

---

## Page 192

written	this	book	had	Jim	not	pointed	the	way	forward	in	his	own
groundbreaking	work.
And	I	thank	Walter	Isaacson,	biographer	extraordinaire,	whose	good
counsel	and	advice	were	instrumental	as	Measure	What	Matters	began	to	take
shape.
I’d	also	like	to	thank	my	partners	at	Kleiner	Perkins,	whose	commitment
to	entrepreneurs	lifts	me	up	every	day:	Mike	Abbott,	Brook	Byers,	Eric	Feng,
...
The	four	OKR	superpowers,	supported	and	made	meaningful	by	CFRs,	are
the	scaffolding	for	Measure	What	Matters.	But	this	book	would	be	hollow
without	our	insider	stories	to	depict	OKRs	and	CFRs	in	real	life	and	real	time.
So	here	is	a	special	thanks	to	the	storytellers,	who	shared	so	generously	from
their	experiences.
I	want	to	start	with	the	Gates	Foundation	team,	past	and	present,	who	are
especially	inspiring	for	the	breathtaking	scope	and	lifesaving	impact	of	their
work.	Thank	you,	Bill	and	Melinda,	Patty	Stonesifer,	Larry	Cohen,	Bridgitt
Arnold,	Sylvia	Mathews	Burwell,	Susan	Desmond-Hellman,	Mark	Suzman,
and	Ankur	V ora.	Y our	achievement	will	make	its	own	epic	book	that	we
cannot	wait	to	read.
Thanks	to	our	favorite	Irish	rock	star,	who	has	built	a	global	crusade	to
fight	disease,	poverty,	and	corruption.	Thank	you	Bono	and	your	team	of
Jamie	Drummond,	David	Lane,	Lucy	Matthew,	Bobby	Shriver,	Gayle	Smith,
and	Ken	Weber	for	your	creation	of	ONE.
Now,	the	Google	gang	merits	special	mention.	Y es,	Larry	Page,	Sergey
Brin,	and	Eric	Schmidt	have	made	Google	the	twenty-first-century	prototype
for	structured	goal	setting.	Their	resolve	and	results	with	OKRs	impressed
even	Andy	Grove.	But	I	would	be	remiss	not	to	recognize	as	well	the
100,000-plus	Google	employees	and	alumni	who	have	spread	the	goals	gospel
globally.	I	particularly	thank	Sundar	Pichai,	Susan	Wojcicki,	Jonathan
Rosenberg,	and	Cristos	Goodrow.	Also,	Tim	Armstrong,	Raja	Ayyagari,
...
Prasad	Setty,	Ram	Shriram,	Esther	Sun,	Matt	Susskind,	Astro	Teller,	and	Kent
Walker.
Intel’s	past	and	present	leaders	were	magnanimous	with	their	insights.
Thank	you	to	Gordon	Moore,	Les	V adasz,	Eva	Grove,	Bill	Davidow,	Dane
...
Rodgers,	Kelly	Kelly,	and	to	Terry	Murphy,	Andy	Grove’s	longtime	executive
assistant.
...
From	Coursera:	Lila	Ibrahim,	Daphne	Koller,	Andrew	Ng,	Rick	Levin,
and	Jeff	Maggioncalda.
...
Aaron	Butkus;	Ivy	Choy;	John	Chu;	Roger	Corn;	Angus	Davis;	Chris
Deptula;	Patrick	Foley;	Uwe	Higgen;	Arnold	Hur;	General	Tom	Kolditz;
Cory	Kreeck;	Jonathan	Lesser;	Aaron	Levie;	Kevin	Louie;	Denise	Lyle;	Chris
Mason;	Amelia	Merrill;	Deep	Nishar;	Bill	Pence;	Stephanie	Pimmel;	Philip
Potloff;	Aurelie	Richard;	Dr.	David	Rock;	Timo	Salzsieder;	Jake	Schmidt;
Erin	Sharp;	Jeff	Smith;	Tim	Staffa;	Joseph	Suzuki;	Chris	Villar;	Jeff	Weiner;
Christina	Wodtke;	and	Jessica	Woodall.
...
Not	least,	I’d	like	to	thank	some	special	individuals	with	whom	I’ve	been
privileged	to	work	over	the	years,	and	whose	lives	are	exemplars	of
...
I	sincerely	thank	Jeff	Coplon,	who	was	at	the	center	of	the	team	that	made
this	happen—and	who	proved,	once	again,	that	execution	is	everything.
Long	before	I	encountered	OKRs,	my	father	and	hero,	Lou	Doerr,	taught
me	the	value	of	focus,	commitment,	high	standards,	and	higher	aspirations
...
through	this	long	and	challenging	project.	Each	and	every	day,	they	remind
me	of	what	matters	the	most.
...
Lives	(New	Y ork:	Simon	&	Schuster,	2011).	In	some	cases,	the	key	result	is	binary,	either	done	or
...
Y ork:	Grand	Central	Publishing,	2014).
...
Scientific	management,	Taylor	wrote
:	Frederick	Winslow	Taylor,	The	Principles	of	Scientific
Management	(New	Y ork	and	London:	Harper	&	Brothers,	1911).
“crisp	and	hierarchical”:	Andrew	S.	Grove,	High	Output	Management	(New	Y ork:	Random	House,
1983).
“a	principle	of	management”:	Peter	F.	Drucker,	The	Practice	of	Management	(New	Y ork:	Harper	&
Row,	1954).
...
World’ s	Most	Powerful	Chip	Company	(New	Y ork:	Dutton,	1997).
...
the	World’ s	Most	Powerful	Chip	Company	(New	Y ork:	Dutton,	1997).
...
values	cannot	be	transmitted:	Andrew	S.	Grove,	High	Output	Management	(New	Y ork:	Random
House,	1983).
“When	you’re	the	CEO”:	“Lessons	from	Bill	Campbell,	Silicon	V alley’s	Secret	Executive	Coach,”
...
“must	be	able	to	measure”:	Peter	F.	Drucker,	The	Practice	of	Management	(New	Y ork:	Harper	&
Row,	1954).
...
a	manager’s	teenage	daughter
:	Stacy	Cowley	and	Jennifer	A.	Kingson,	“Wells	Fargo	Says	2	Ex-
...
Andrew	M.	Slavitt
:	Steve	Lohr,	“Medicaid’s	Data	Gets	an	Internet-Era	Makeover,”	New	York	Times,
January	9,	2017.
...
The	term	for	this	linkage:	According	to	the	Harvard	Business	Review,	companies	with	highly	aligned
employees	are	more	than	twice	as	likely	to	be	top	performers	as	their	competition	(“How
Employee	Alignment	Boosts	the	Bottom	Line,”	Harvard	Business	Review,	June	16,	2016).
Studies	suggest	that:	Robert	S.	Kaplan	and	David	P .	Norton,	The	Strategy-Focused	Organization:	How
Balanced	Scorecard	Companies	Thrive	in	the	New	Business	Environment	(Boston:	Harvard
Business	School	Press,	2001).
a	poll	of	global	CEOs
:	Donald	Sull,	“Closing	the	Gap	Between	Strategy	and	Execution,”	MIT	Sloan
Management	Review,	July	1,	2007.
“We’ve	got	a	lot”:	Interview	with	Amelia	Merrill,	people	strategy	leader	at	RMS.
“Having	goals	improves	performance”:	Laszlo	Bock,	Work	Rules!:	Insights	from	Inside	Google	That
Will	Transform	How	You	Live	and	Lead	(New	Y ork:	Grand	Central	Publishing,	2015).
“People	in	the	trenches”:	Andrew	S.	Grove,	Only	the	Paranoid	Survive:	How	to	Identify	and	Exploit
the	Crisis	Points	That	Challenge	Every	Business	(New	Y ork:	Doubleday	Business,	1996).
The	“professional	employee”:	Peter	Drucker,	The	Practice	of	Management	(New	Y ork:	Harper	&
Row,	1954).
dim	view	of	“managerial	meddling”:	Andrew	S.	Grove,	High	Output	Management	(New	Y ork:
Random	House,	1983).
“The	higher	the	goals”:	Edwin	Locke	and	Gary	Latham,	“Building	a	Practically	Useful	Theory	of
Goal	Setting	and	Task	Motivation:	A	35-Y ear	Odyssey,”	American	Psychologist,	September	2002.
...
“Whenever	Intuit	makes”:	Vindu	Goel,	“Intel	Sheds	Its	PC	Roots	and	Rises	as	a	Cloud	Software
Company,”	New	York	Times,	April	10,	2016.
CHAPTER	10:	Superpower	#3:	Track	for	Accountability
Research	suggests	that	making:	Teresa	Amabile	and	Steven	Kramer,	The	Progress	Principle:	Using
Small	Wins	to	Ignite	Joy,	Engagement,	and	Creativity	at	Work	(Boston:	Harvard	Business	Review
Press,	2011).
“The	single	greatest	motivator”
:	Daniel	H.	Pink,	Drive:	The	Surprising	Truth	About	What	Motivates
Us	(New	Y ork:	Riverhead	Books,	2009).
“Without	an	action	plan”:	Peter	Drucker,	The	Effective	Executive:	The	Definitive	Guide	to	Getting	the
Right	Things	Done	(New	Y ork:	Harper	&	Row,	1967).
...
“If	the	ladder	is	not”:	Stephen	R.	Covey,	The	7	Habits	of	Highly	Effective	People	(New	Y ork:	Simon
&	Schuster,	1989).
“people	can	learn	from	failure”:	“Don’t	Be	Modest:	Decrypting	Google,”	The	Economist,	September
27,	2014.
Learning	“from	direct	experience”:	Giada	Di	Stefano,	Francesca	Gino,	Gary	Pisano,	and	Bradley
Staats,	“Learning	by	Thinking:	How	Reflection	Improves	Performance,”	Harvard	Business	School
working	paper,	April	11,	2014.
“We	do	not	learn”
:	Ibid.
CHAPTER	12:	Superpower	#4:	Stretch	for	Amazing
For	companies	seeking:	Steve	Kerr,	“Stretch	Goals:	The	Dark	Side	of	Asking	for	Miracles,”	Fortune,
November	13,	1995.
...
“A	BHAG	is	a	huge”:	Jim	Collins,	Good	to	Great:	Why	Some	Companies	Make	the	Leap	.	.	.	and
Others	Don’ t	(New	Y ork:	HarperCollins,	2001).
...
“Setting	specific	challenging	goals”:	Edwin	A.	Locke	and	Gary	P .	Latham,	“Building	a	Practically
Useful	Theory	of	Goal	Setting	and	Task	Motivation:	A	35-Y ear	Odyssey,”	American	Psychologist,
September	2002.
“stretched”	goals	could	elicit:	Andrew	S.	Grove,	High	Output	Management	(New	Y ork:	Random
House,	1983).
“This	is	Intel”:	“Intel	Crush	Oral	History	Panel,”	Computer	History	Museum,	October	14,	2013.
By	the	third	quarter:	William	H.	Davidow,	Marketing	High	Technology:	An	Insider’ s	View	(New
Y ork:	Free	Press,	1986).
“the	gospel	of	10x”:	Steven	Levy,	“Big	Ideas:	Google’s	Larry	Page	and	the	Gospel	of	10x,”	Wired,
March	30,	2013.
“tend	to	assume	that”:	Eric	Schmidt	and	Jonathan	Rosenberg,	How	Google	Works	(New	Y ork:	Grand
Central	Publishing,	2014).
“The	way	Page	sees	it”:	Levy,	“Big	Ideas.”
start	of	the	period:	Interview	with	Bock.
In	pursuing	high-effort:	Locke	and	Latham,	“Building	a	Practically	Useful	Theory	of	Goal	Setting	and
Task	Motivation.”
“Y ou	know,	in	our	business”:	iOPEC	seminar,	1992.
CHAPTER	13:	Stretch:	The	Google	Chrome	Story
“If	you	want	your	car”:	Laszlo	Bock,	Work	Rules!:	Insights	from	Inside	Google	That	Will	Transform
How	You	Live	and	Lead	(New	Y ork:	Grand	Central	Publishing,	2015).
“If	you	set	a	crazy”:	Ibid.
“Dear	Sophie,”	a	spot:	https://whatmatters.com/sophie.
CHAPTER	14:	Stretch:	The	Y ouTube	Story
“the	most	powerful	woman”:	Belinda	Luscombe,	“Meet	Y ouTube’s	Viewmaster,”	Time,	August	27,
2015.
“the	true	scarce	commodity”:	Satya	Nadella,	company-wide	email	to	Microsoft	employees,	June	25,
2015.
CHAPTER	15:	Continuous	Performance	Management:	OKRs	and
CFRs
Y et	only	12	percent:	“Performance	Management:	The	Secret	Ingredient,”	Deloitte	University	Press,
February	27,	2015.
Only	6	percent	think:	“Global	Human	Capital	Trends	2014:	Engaging	the	21st	Century	Workforce,”
Bersin	by	Deloitte.
A	manager’s	“first	role”:	www.druckerinstitute.com/2013/07/measurement-myopia.
Table	15.1:	Annual	Performance	Management:	Josh	Bersin	and	BetterWorks,	“How	Goals	Are
Driving	a	New	Approach	to	Performance	Management,”	Human	Capital	Institute,	April	4,	2016.
Andy	Grove	estimated:	Andrew	S.	Grove,	High	Output	Management	(New	Y ork:	Random	House,
1983).
Andy	believed	the	“subordinate”:	“Former	Intel	CEO	Andy	Grove	Dies	at	79,”	Wall	Street	Journal,
March	22,	2016.	When	I	met	with	my	boss	at	Intel,	it	wasn’t	for	him	to	inspect	my	work,	but
rather	to	figure	out	how	he	could	help	me	achieve	my	key	results.
According	to	Gallup:	Annamarie	Mann	and	Ryan	Darby,	“Should	Managers	Focus	on	Performance	or
Engagement?”	Gallup	Business	Journal,	August	5,	2014.
“Feedback	is	an	opinion”:	Sheryl	Sandberg,	Lean	In:	Women,	Work,	and	the	Will	to	Lead	(New	Y ork:
Knopf,	2013).
...
“As	soft	as	it	seems”:	“Becoming	Irresistible:	A	New	Model	for	Employee	Engagement,”	Deloitte
Review,	issue	16.
CHAPTER	18:	Culture
these	five	questions:	https://rework.withgoogle.com/blog/five-keys-to-a-successful-google-team.
High-motivation	cultures,	they	concluded:	Teresa	Amabile	and	Steven	Kramer,	“The	Power	of	Small
Wins,”	Harvard	Business	Review,	May	2011.
His	team	at	LRN:	The	study	was	conducted	by	the	Boston	Research	Group,	the	Center	for	Effective
Organizations	at	the	University	of	Southern	California,	and	Research	Data	Technology,	Inc.
DEDICATION
As	Ken	Auletta	wrote:	Ken	Auletta,	“Postscript:	Bill	Campbell,	1940–2016,”	The	New	Yorker,	April
19,	2016.
“Bill	Campbell	has	been”:	Eric	Schmidt	and	Jonathan	Rosenberg,	How	Google	Works	(New	Y ork:
Grand	Central	Publishing,	2014).
He	“kept	Steve	Jobs	going”:	Miguel	Helft,	“Bill	Campbell,	‘Coach’	to	Silicon	V alley	Luminaries	Like
...
INDEX
The	page	numbers	in	this	index	refer	to	the	printed	version	of	this	book.	The	link	provided	will	take	you
to	the	beginning	of	that	print	page.	Y ou	may	need	to	scroll	forward	from	that	location	to	find	the
...
Y ouTube’s	billion-hour,	163,	164,	165–69
Big	Rocks	Theory,	160
billion-hour	BHAG	of	Y ouTube,	163,	164,	165–69
...
DA TA	(Debt,	AIDS,	Trade,	Africa),	234,	237,	238–39
dating	OKRs,	264
...
Disability-Adjusted	Life	Y ears	(DAL Y),	128
...
Glassdoor,	217
Global	Alliance	for	V accines	and	Immunization	(GA VI),	131
Gmail,	14,	87,	138–39
...
Google.	See	also	Chrome;	Y ouTube
...
Monthly	Active	Teachers	(MA T),	64
...
Weekly	Active	Teachers	(W A T),	64
Weiner,	Jeff,	50
Wells	Fargo,	53
...
*	The	rare	exceptions	are	true	disruptors.	Exhibit	B:	The	iPod,	which	lagged	at	least	nine	other	digital	audio	players	into
...
*	In	2001,	at	my	suggestion,	the	founders	recruited	Eric	Schmidt,	my	old	colleague	at	Sun	Microsystems,	to	be	their	CEO.	Eric
...
*	I’d	personally	learned	this	drill	at	Intel	in	the	1970s.	Gordon	Moore,	the	legend	who	preceded	Andy	Grove	as	Intel’s	CEO,
...
*	In	the	very	beginning,	Google	relied	on	“snippets,”	three-	or	four-line	status	reports	on	each	individual’s	work.

---

## Page 220

*	Google	originally	used	quarterly	OKRs,	then	added	annual	OKRs	for	a	two-track	process.	Since	succeeding	Larry	Page	as	CEO,
...
*	As	did	Stanford	University,	where	he	gave	one	hundred	hours	of	his	life	each	year	to	sixty	graduate	business	students.
...
*	We	can	see	Grove’s	influence	on	Steve	Jobs,	with	whom	he	had	a	very	close	and	very	complicated	relationship.
...
*	Of	Intel’s	two	thousand	employees	at	the	time,	more	than	half	were	detailed	to	Crush.	Everybody	else	was	on	call.
...
*	For	a	more	comprehensive	manual,	see	“Google’s	OKR	Playbook,”	in	the	resource	section	at	the	back	of	this	book.

---

## Page 233

*	Usually	this	will	apply	to	a	key	result,	or	how	you’re	going	about	something.	A	thoughtfully	set	objective	is	less	likely	to
...
*	Google’s	floor	of	0.7	for	successful	attainment	reflects	the	high	ambition	of	their	“stretch”	goals.	(See	chapter	12.)	This
...
*	This	KR	reflects	the	awesome,	compounding	power	of	Moore’s	law.	Eight	megahertz	was	blazing	speed	at	the	time,	but	today
...
*	As	the	Gates	Foundation	made	a	series	of	eight-figure	grant	awards	to	the	Carter	Center,	the	number	of	reported	cases	of	Guinea
...
*	According	to	the	World	Health	Organization,	the	mosquito	is	responsible	for	725,000	deaths	per	year.	Female	Anopheles
...
*	A	module	of	web-development	techniques	that	enabled	users	to	communicate	with	a	server	without	reloading	a	page	or
...
*	I	had	the	great	good	fortune	of	working	on	Chrome	and	even	sharing	an	office	with	Linus	Upson,	who	led	the	team’s
...
*	Though	it’s	a	work	in	progress,	Y ouTube	now	intersperses	some	ads	mid-video,	to	correspond	to	its	new	definition	of	value.

---

## Page 243

*	Andy	believed	the	“subordinate”	should	do	90	percent	of	the	talking.	When	I	met	with	my	boss	at	Intel,	he	focused	on	how	he
...
*	For	more	information	on	the	company’s	fresh	approach,	I	invite	you	to	explore	their	open	source	content	at
...
*	Bill	had	captained	the	team	to	its	only	Ivy	League	title,	in	1961,	as	a	tough-as-nails,	165-pound	linebacker.	Half	a	century	later,
